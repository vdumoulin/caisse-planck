...
SWIGEXPORT void JNICALL Java_drawerControllib_DrawerControlJNI_openCommunication(JNIEnv *jenv, jclass jcls) {
  (void)jenv;
  (void)jcls;
  {
    char *err;
...
SWIGEXPORT void JNICALL Java_drawerControllib_DrawerControlJNI_closeCommunication(JNIEnv *jenv, jclass jcls) {
  (void)jenv;
  (void)jcls;
  {
    char *err;
